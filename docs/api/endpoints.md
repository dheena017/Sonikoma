...
_Note: This is a high-level summary. The actual FastAPI implementation may expose additional query parameters or granular error codes. For full dynamic documentation, refer to the `/docs` (Swagger UI) endpoint when the backend is running._
