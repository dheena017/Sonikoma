...
_Goal: Establish baseline architectural constraints, decision records (ADRs), coding standards, and technical debt mapping._
...
_Goal: Decouple inline fetch requests from UI elements and centralize API routing under a unified network client._
...
_Goal: Extract sub-components and layout panels out of bloated page files like `App.tsx` and `CinemaPlayer.tsx`._
