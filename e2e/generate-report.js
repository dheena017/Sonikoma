...
const TEST_ITEMS = [
  ...
  },
  {
    ...
    name: "API-AUDIO-001: GET /api/v1/audio/list-tts-voices returns neural voice actors",
    endpoint: "/api/v1/audio/list-tts-voices",
    ...
    responseSample: {
      voices: [
        { id: "en-US-GuyNeural", gender: "Male", style: "Narrator" },
        { id: "en-US-JennyNeural", gender: "Female", style: "Heroine" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    responseSample: {
      detail: [{ loc: ["body", "timeline"], msg: "field required" }],
    },
  },
  {
    id: "api-video-002",
    ...
    requestSample: {},
    responseSample: {
      presets: ["1080p_16x9_60fps", "4k_16x9_60fps", "1080p_9x16_shorts"],
    },
  },
  {
    id: "api-jobs-001",
  ...
  },
  {
    ...
    requestSample: {},
    responseSample: {
      detail: [{ loc: ["query", "job_id"], msg: "field required" }],
    },
  },
  {
    id: "api-system-001",
  ...
  },
  {
    ...
    requestSample: {},
    responseSample: {
      detail: [{ loc: ["query", "url"], msg: "field required" }],
    },
  },
  {
    id: "api-proxy-002",
  ...
  // ── 02. FUNCTIONS & MATH SUITE ──
  {
    ...
    requestSample: {
      input:
        "https://www.webtoons.com/en/fantasy/tower-of-god/ep-1?utm_source=share#panel",
    },
    responseSample: {
      normalized: "https://www.webtoons.com/en/fantasy/tower-of-god/ep-1",
    },
  },
  {
    id: "func-scraper-002",
  ...
  },
  {
    ...
    requestSample: {
      caption:
        "This is a very long panel caption that exceeds maximum character length",
    },
  ...
  // ── 03. UI BUTTON TRIGGERS SUITE ──
  {
    ...
    responseSample: {
      triggered_event: "open_project_modal",
      modal_visible: true,
    },
  },
  {
    ...
    responseSample: {
      input_value:
        "https://www.webtoons.com/en/fantasy/tower-of-god/episode-1/viewer?title_no=95&episode_no=1",
    },
  },
  {
    id: "ui-nav-001",
    ...
    requestSample: {
      ...
      elements: ["#nav-projects", "#nav-scraper", "#nav-settings"],
    },
  ...
  },
  {
    ...
    statusCode: 200,
    tracePrefix:
      "button_triggers-03_editor_action_buttons-UI-AUTOCROP-SLIDER-001",
  ...
  },
  {
    ...
    statusCode: 200,
    tracePrefix:
      "button_triggers-06_admin_action_buttons-UI-ADMIN-SUITE-FILTER-002",
...
if (fs.existsSync(testResultsDir)) {
  ...
  TEST_ITEMS.forEach((test) => {
    ...
    let matchedDir = resultDirs.find(
      (d) =>
        d.startsWith(test.tracePrefix) ||
        d.toLowerCase().includes(test.id.toLowerCase())
    );
...
const buttonsCount = TEST_ITEMS.filter(
  (t) => t.suite === "button_triggers"
).length;
...
console.log(
  `✨ [Sonikoma Studio Portal] Successfully compiled Live Auto-Updating Test Portal with ${totalTestsCount} tests (${endpointsCount} Endpoints, ${functionsCount} Functions, ${buttonsCount} Buttons)!`
);
