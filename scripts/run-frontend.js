...
const logger = {
  info: (msg, ...args) => console.log(formatLog('INFO', 'run-frontend.js', msg), ...args),
  success: (msg, ...args) => console.log(formatLog('SUCCESS', 'run-frontend.js', msg), ...args),
  warn: (msg, ...args) => console.warn(formatLog('WARNING', 'run-frontend.js', msg), ...args),
  error: (msg, ...args) => console.error(formatLog('ERROR', 'run-frontend.js', msg), ...args)
};
...
async function start() {
  ...
  if (isRunning) {
    ...
    if (onlyFrontend) {
      ...
      logger.warn(`Starting frontend only (API calls will fail until backend is started).`);
    } else {
