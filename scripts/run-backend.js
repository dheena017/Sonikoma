...
const logger = {
  info: (msg, ...args) => console.log(formatLog('INFO', 'run-backend.js', msg), ...args),
  success: (msg, ...args) => console.log(formatLog('SUCCESS', 'run-backend.js', msg), ...args),
  warn: (msg, ...args) => console.warn(formatLog('WARNING', 'run-backend.js', msg), ...args),
  error: (msg, ...args) => console.error(formatLog('ERROR', 'run-backend.js', msg), ...args)
};
