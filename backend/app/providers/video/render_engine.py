...
class RenderEngine:
    ...
    async def extract_frames(
        ...
        cmd = ffmpeg_cmds.build_extract_frames_cmd(
    ...
    async def extract_audio(
        ...
        cmd = ffmpeg_cmds.build_extract_audio_cmd(self.ffmpeg_path, video_path, output_path, format_str, bitrate)
    ...
    async def concatenate_videos(
        ...
        cmd = ffmpeg_cmds.build_concatenate_videos_cmd(self.ffmpeg_path, concat_file, output_path, fps, width, height)
        ...
        try:
            with open(concat_file, "w") as f:
                for i, cut in enumerate(cuts):
                    ...
                    cmd = ffmpeg_cmds.build_cut_video_cmd(self.ffmpeg_path, video_path, cut.start_time, cut.end_time, segment_path)
    ...
    async def adjust_speed(
        ...
        cmd = ffmpeg_cmds.build_adjust_speed_cmd(self.ffmpeg_path, video_path, output_path, speed_factor, preserve_pitch)
    ...
    async def apply_filter(
        ...
        cmd = ffmpeg_cmds.build_apply_filter_cmd(self.ffmpeg_path, video_path, output_path, filter_type, intensity)
    ...
    async def mix_audio(
        ...
        cmd = ffmpeg_cmds.build_mix_audio_cmd(self.ffmpeg_path, video_path, audio_paths, audio_volumes, output_path)
