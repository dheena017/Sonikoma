"""
backend/app/services/audio/speech_transcriber.py
─────────────────────────────────────────────────────────────────────────────
...
from engines.whisper.engine import TranscriptionResult, get_whisper_engine, WhisperModel, WHISPER_AVAILABLE

logger = logging.getLogger("sonikoma.services.audio.speech_transcriber")


def _ensure_whisper_engine(model_name: WhisperModel = "base", device: str = "cpu"):
