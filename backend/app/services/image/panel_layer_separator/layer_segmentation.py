...
logger = logging.getLogger("sonikoma.services.image.panel_layer_separator.layer_segmentation")
...
from services.image.panel_detector.webtoon_detect import _detect_bg_color_and_threshold
