...
from services.image.panel_detector.detector import run_cv_detection
from services.image.panel_layer_separator.layer_segmentation import process_layers, create_blank_webp

logger = logging.getLogger("sonikoma.services.image.panel_layer_separator.layers")
...
async def debug_yolo_detections_service(url: str, conf: float = 0.25) -> bytes:
    ...
    try:
        ...
        from services.image.panel_detector.debug_visualizer import draw_yolo_detections
