...
async def extract_panel_layers_service(*args, **kwargs):
    from services.image.layer_separation.layer_separator import extract_panel_layers_service as _impl
    return await _impl(*args, **kwargs)

async def debug_yolo_detections_service(*args, **kwargs):
    from services.image.layer_separation.layer_separator import debug_yolo_detections_service as _impl
    return await _impl(*args, **kwargs)
