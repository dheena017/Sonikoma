...
class ProjectUpdateRequest(BaseModel):
    ...
    panels_count: Optional[int] = Field(None, description="Number of panels or extracted images")
    imported_assets_count: Optional[int] = Field(None, description="Number of imported comic image assets")
    scraped_images: Optional[List[str]] = Field(None, description="List of scraped comic image URLs")
