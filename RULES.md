...
| 2026-06-08 | Refactored Crop tool: fixed visibility/lag, updated theme to purple, renamed "Cuts" tab to "Crop", implemented aspect ratio validation, and hardened interactions | `frontend/src/components/crop/*`, `frontend/src/hooks/useCropEditor*` |
