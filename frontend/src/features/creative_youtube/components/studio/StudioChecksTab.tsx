    ...
    <div className="space-y-5 animate-fade-in">
      <div className="border-b border-neutral-800 pb-4">
        ...
        <p className="text-xs text-neutral-400 font-mono mt-0.5">
          We'll let you know if there are any issues with your video before
          publishing
        </p>
      </div>
      ...
      <div className="space-y-3 p-4 bg-neutral-950/40 rounded-2xl border border-neutral-800/80">
        ...
        <p className="text-[10.5px] text-neutral-400 font-mono leading-relaxed">
          Certify your video doesn't contain the following content to get a
          better audience match.
        </p>
        <div className="space-y-2">
          {(Object.entries(ratings) as [keyof typeof ratings, boolean][]).map(
            ([key, val]) => {
