...
export default function YouTubeChannelModal({
  ...
  const [filterType, setFilterType] = useState<"all" | "active" | "brand">(
    "all"
  );
  ...
  const handleAuthorizeYouTube = async (
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.auth_url) {
          addNotification?.(
            "Opening Google Brand Account & channel chooser…",
            "info"
          );
  ...
  const handleLookupChannel = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.channel) {
        ...
        setLookupError(
          data.detail || "No YouTube channel found matching this handle/ID."
        );
      }
    } catch {
      setLookupError(
  ...
  const filteredChannels = useMemo(() => {
    return channels.filter((ch) => {
      ...
      if (filterType === "active")
        return ch.is_selected === 1 || ch.id === selectedId;
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400 font-mono mt-0.5">
                  Choose, manage, and sync your YouTube channels & Brand
                  Accounts
                </p>
              </div>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center py-8 px-4 gap-5 text-center">
              ...
              <div className="space-y-1.5 max-w-md">
                ...
                <p className="text-xs text-neutral-400 font-mono leading-relaxed">
                  ...
                  recaps and analytics. Sign in with Google to choose your
                  channel or Brand Account.
                </p>
              </div>
            ...
            <div className="flex flex-col items-center py-8 px-4 gap-4 text-center">
              ...
              <div className="space-y-1.5 max-w-md">
                ...
                <p className="text-xs text-neutral-400 font-mono leading-relaxed">
                  Choose another Google Brand Account or enter your channel
                  handle directly.
                </p>
              </div>
                        ...
                        <div className="flex-1 min-w-0 pr-2">
                          ...
                          <div className="flex flex-wrap items-center gap-2 mt-2 text-[11px] font-mono">
                            ...
                            <span className="flex items-center gap-1.5 px-2 py-0.5 rounded-lg bg-emerald-950/40 border border-emerald-800/40 text-emerald-400 text-[10px] font-bold">
                              <ShieldCheck className="w-3 h-3" /> Full Studio
                              Access
                            </span>
                          </div>
                        </div>
                ...
                <div className="mt-4 p-4 rounded-2xl bg-neutral-900/80 border border-neutral-800/90 space-y-3 animate-in fade-in duration-200">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px] font-mono text-neutral-400">
                    <div className="p-2 bg-neutral-950/80 border border-neutral-800/60 rounded-xl">
                      ...
                      <div className="text-neutral-200 font-bold mt-0.5 capitalize">
                        {selectedChannelObj.type || "Personal"} Account
                      </div>
                    </div>
                    <div className="p-2 bg-neutral-950/80 border border-neutral-800/60 rounded-xl">
                      <div className="text-[10px] text-neutral-500 uppercase">
