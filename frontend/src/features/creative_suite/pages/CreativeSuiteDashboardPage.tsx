...
const CreativeSuiteDashboardPage: React.FC<CreativeSuiteDashboardPageProps> = ({
  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto animate-fade-in text-left">
      ...
      <div className="rounded-[28px] border border-[#2F2F2F] bg-gradient-to-b from-[#181818] via-[#141414] to-[#0E0E0E] p-4 sm:p-8 lg:p-9 shadow-2xl space-y-8 relative overflow-hidden">
        {/* Welcome Hero Header */}
