...
const CreativeSuiteMiniSidebarInner: React.FC<CreativeSuiteMiniSidebarProps> = ({
  ...
  return (
    <aside className="fixed top-16 bottom-0 left-0 w-20 bg-[#070709] border-r border-neutral-900 hidden lg:flex flex-col items-center py-4 z-40 shadow-[4px_0_24px_rgba(0,0,0,0.3)] select-none">
