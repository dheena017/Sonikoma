    ...
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-neutral-950/40 p-2 rounded-xl border border-transparent shadow-inner shadow-black/10">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <select
          ...
          className="bg-neutral-900 border border-neutral-800 text-neutral-200 rounded-lg px-3 py-1.5 text-[10px] focus:border-neutral-600 focus:outline-none cursor-pointer font-bold font-mono transition-colors shadow-sm"
        >
      ...
      <div className="relative flex items-center w-full md:w-56">
        <input
          ...
          className="w-full bg-neutral-900 border border-neutral-900/60 text-neutral-200 rounded-lg pl-7 pr-7 py-1 text-[10px] focus:border-neutral-600 focus:outline-none placeholder-neutral-500 transition-colors"
        />
