    ...
    <div className="space-y-3 bg-[#1E1E1E] p-4 rounded-2xl border border-[#2F2F2F] shadow-md">
      ...
      <div className="flex gap-2 items-center">
        ...
        {selectedTemplate && (
          <button
            ...
            className="p-2 text-neutral-400 hover:text-rose-400 bg-[#2A2A2A] hover:bg-[#333333] border border-[#2F2F2F] hover:border-neutral-700 rounded-xl transition-colors cursor-pointer"
      ...
      <div className="flex gap-2 pt-2 border-t border-[#2F2F2F]">
        <input
          ...
          className="flex-1 text-xs font-mono bg-[#121212] border border-[#2F2F2F] rounded-xl py-2 px-3 text-white placeholder:text-neutral-500 focus:outline-none focus:border-neutral-600"
        />
        <button
          type="button"
          onClick={handleSaveTemplate}
          disabled={!newTemplateName.trim() || splitLines.length === 0}
          className="bg-[#2A2A2A] hover:bg-[#333333] disabled:opacity-40 disabled:cursor-not-allowed border border-[#2F2F2F] hover:border-neutral-700 text-neutral-200 hover:text-white text-xs font-bold py-2 px-4 rounded-xl font-mono transition-all cursor-pointer flex items-center gap-1.5 shadow-sm"
