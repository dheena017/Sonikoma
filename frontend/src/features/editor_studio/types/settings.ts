...
export const MUSIC_THEMES_CATALOG = [
  {
    ...
    label: "Orchestral Battle Theme",
    icon: "⚔️",
    mood: "Epic",
  },
  {
    id: "mysterious_ambience",
    label: "Mysterious Ambience",
    icon: "🌫️",
    mood: "Tense",
  },
  {
    id: "scifi_synth",
    label: "Sci-Fi Synth Wave",
    icon: "🚀",
    mood: "Futuristic",
  },
  {
    id: "calm_acoustic",
    label: "Calm Acoustic Melancholy",
    icon: "🎸",
    mood: "Emotional",
  },
  {
    id: "no_music",
    label: "No Music (Dialogue Only)",
    icon: "🔇",
    mood: "Silent",
  },
];
...
export const DEFAULT_TTS_VOICES: TTSVoiceOption[] = [
  ...
  },
  {
    ...
    label: "English (India) — Prabhat (Male)",
    gender: "Male",
    lang: "English",
  },
  {
    code: "en-IN-NeerjaNeural",
    label: "English (India) — Neerja (Female)",
    gender: "Female",
    lang: "English",
  },
  ...
  },
  {
    ...
    label: "Japanese — Keita (Male)",
    gender: "Male",
    lang: "Japanese",
  },
  {
    code: "ja-JP-AoiNeural",
    label: "Japanese — Aoi (Female)",
    gender: "Female",
    lang: "Japanese",
  },
  {
    code: "ja-JP-DaichiNeural",
    label: "Japanese — Daichi (Male)",
    gender: "Male",
    lang: "Japanese",
  },
  ...
  },
  {
    ...
    label: "Korean — BongJin (Male)",
    gender: "Male",
    lang: "Korean",
  },
  {
    code: "ko-KR-YuJinNeural",
    label: "Korean — YuJin (Female)",
    gender: "Female",
    lang: "Korean",
  },
  ...
  // Spanish
  {
    ...
    label: "Spanish (Spain) — Alvaro (Male)",
    gender: "Male",
    lang: "Spanish",
  },
  {
    code: "es-ES-ElviraNeural",
    label: "Spanish (Spain) — Elvira (Female)",
    gender: "Female",
    lang: "Spanish",
  },
  {
    code: "es-MX-DaliaNeural",
    label: "Spanish (Mexico) — Dalia (Female)",
    gender: "Female",
    lang: "Spanish",
  },
  {
    code: "es-MX-JorgeNeural",
    label: "Spanish (Mexico) — Jorge (Male)",
    gender: "Male",
    lang: "Spanish",
  },
  ...
  // French
  {
    ...
    label: "French (France) — Henri (Male)",
    gender: "Male",
    lang: "French",
  },
  {
    code: "fr-FR-DeniseNeural",
    label: "French (France) — Denise (Female)",
    gender: "Female",
    lang: "French",
  },
  {
    code: "fr-CA-SylvieNeural",
    label: "French (Canada) — Sylvie (Female)",
    gender: "Female",
    lang: "French",
  },
  ...
  // German
  {
    ...
    label: "German — Conrad (Male)",
    gender: "Male",
    lang: "German",
  },
  {
    code: "de-DE-KatjaNeural",
    label: "German — Katja (Female)",
    gender: "Female",
    lang: "German",
  },
  {
    code: "de-DE-AmalaNeural",
    label: "German — Amala (Female)",
    gender: "Female",
    lang: "German",
  },
  ...
  },
  {
    ...
    label: "Chinese (Mandarin) — Yunxi (Male)",
    gender: "Male",
    lang: "Chinese",
  },
  {
    code: "zh-CN-YunjianNeural",
    label: "Chinese (Mandarin) — Yunjian (Male)",
    gender: "Male",
    lang: "Chinese",
  },
  {
    code: "zh-HK-HiuMaanNeural",
    label: "Chinese (Cantonese) — HiuMaan (Female)",
    gender: "Female",
    lang: "Chinese",
  },
  ...
  },
  {
    ...
    label: "Tamil (Sri Lanka) — Saranya (Female)",
    gender: "Female",
    lang: "Tamil",
  },
  {
    code: "ta-LK-KumarNeural",
    label: "Tamil (Sri Lanka) — Kumar (Male)",
    gender: "Male",
    lang: "Tamil",
  },
  {
    code: "ta-SG-VenbaNeural",
    label: "Tamil (Singapore) — Venba (Female)",
    gender: "Female",
    lang: "Tamil",
  },
  {
    code: "ta-SG-AnbuNeural",
    label: "Tamil (Singapore) — Anbu (Male)",
    gender: "Male",
    lang: "Tamil",
  },
  {
    code: "ta-MY-KaniNeural",
    label: "Tamil (Malaysia) — Kani (Female)",
    gender: "Female",
    lang: "Tamil",
  },
  {
    code: "ta-MY-SuryaNeural",
    label: "Tamil (Malaysia) — Surya (Male)",
    gender: "Male",
    lang: "Tamil",
  },
  ...
  // Hindi & Indian Languages
  {
    ...
    label: "Hindi (India) — Madhur (Male)",
    gender: "Male",
    lang: "Hindi",
  },
  {
    code: "hi-IN-SwaraNeural",
    label: "Hindi (India) — Swara (Female)",
    gender: "Female",
    lang: "Hindi",
  },
  {
    code: "te-IN-MohanNeural",
    label: "Telugu (India) — Mohan (Male)",
    gender: "Male",
    lang: "Telugu",
  },
  {
    code: "kn-IN-GaganNeural",
    label: "Kannada (India) — Gagan (Male)",
    gender: "Male",
    lang: "Kannada",
  },
  {
    code: "ml-IN-MidhunNeural",
    label: "Malayalam (India) — Midhun (Male)",
    gender: "Male",
    lang: "Malayalam",
  },
  ...
  },
  {
    ...
    label: "Portuguese (Portugal) — Duarte (Male)",
    gender: "Male",
    lang: "Portuguese",
  },
  ...
  // Italian
  {
    ...
    label: "Italian — Diego (Male)",
    gender: "Male",
    lang: "Italian",
  },
  {
    code: "it-IT-ElsaNeural",
    label: "Italian — Elsa (Female)",
    gender: "Female",
    lang: "Italian",
  },
  ...
  // Indonesian & Southeast Asian
  {
    ...
    label: "Indonesian — Ardi (Male)",
    gender: "Male",
    lang: "Indonesian",
  },
  {
    code: "id-ID-GadisNeural",
    label: "Indonesian — Gadis (Female)",
    gender: "Female",
    lang: "Indonesian",
  },
  {
    code: "vi-VN-NamMinhNeural",
    label: "Vietnamese — NamMinh (Male)",
    gender: "Male",
    lang: "Vietnamese",
  },
  {
    code: "vi-VN-HoaiMyNeural",
    label: "Vietnamese — HoaiMy (Female)",
    gender: "Female",
    lang: "Vietnamese",
  },
  {
    code: "th-TH-NiwatNeural",
    label: "Thai — Niwat (Male)",
    gender: "Male",
    lang: "Thai",
  },
  {
    code: "fil-PH-AngeloNeural",
    label: "Filipino — Angelo (Male)",
    gender: "Male",
    lang: "Filipino",
  },
  ...
  // Arabic & Russian
  {
    ...
    label: "Arabic (Saudi) — Hamed (Male)",
    gender: "Male",
    lang: "Arabic",
  },
  {
    code: "ar-SA-ZariyahNeural",
    label: "Arabic (Saudi) — Zariyah (Female)",
    gender: "Female",
    lang: "Arabic",
  },
  {
    code: "ru-RU-DmitryNeural",
    label: "Russian — Dmitry (Male)",
    gender: "Male",
    lang: "Russian",
  },
  {
    code: "ru-RU-SvetlanaNeural",
    label: "Russian — Svetlana (Female)",
    gender: "Female",
    lang: "Russian",
  },
];
