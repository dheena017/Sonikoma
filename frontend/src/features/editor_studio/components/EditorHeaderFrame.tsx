...
export default function EditorHeaderFrame({
  ...
  return (
    <div
      className={`editor-header-frame relative flex flex-wrap sm:flex-nowrap w-full min-h-12 shrink-0 items-center justify-between gap-2 overflow-x-auto rounded-2xl border border-[#3B82F6]/30 bg-gradient-to-r from-neutral-900/95 via-neutral-900/75 to-[#2A2A2A] p-2.5 sm:p-3 pr-3.5 sm:pr-4 backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.5)] select-none z-10 ${className}`}
    >
