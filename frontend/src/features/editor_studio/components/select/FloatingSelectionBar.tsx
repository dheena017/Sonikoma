  ...
  return createPortal(
    <>
      ...
      >
        ...
        >
          <div className={leftDock ? "h-full flex flex-col gap-3 overflow-auto custom-purple-scrollbar pb-1" : "bg-neutral-950/95 backdrop-blur-2xl border-t border-neutral-700/50 px-6 py-4 shadow-2xl shadow-black/60 w-full"}>
                ...
                <div className="flex items-center gap-2 bg-purple-950/60 border border-purple-700/50 rounded-xl px-3.5 py-2 shrink-0">
                  ...
                  <div>
                    <p className="text-xs font-bold text-white leading-tight whitespace-nowrap">
                      {isTimeline ? "Storyboard Panels Selected" : "Imported Assets Selected"}
                    </p>
              ...
              <div className="flex items-center gap-2 flex-wrap shrink-0">
                ...
                {!isTimeline && !leftDock && scrapedImages && scrapedImages.length > 0 && (
                  <ScraperSelectionToolbar
                    ...
                    handleClearAll={handleClearAll || (() => setSelectedScraped?.([]))}
