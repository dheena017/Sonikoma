...
import { categoryOptions } from "@/features/app_shortcuts/components/shortcutUtils";
  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className="w-full bg-neutral-900/50 border border-neutral-800 hover:border-neutral-700 focus:border-neutral-600 focus:ring-4 focus:ring-neutral-700 rounded-2xl pl-12 pr-4 py-3 text-sm text-neutral-200 outline-none transition-all placeholder:text-neutral-600 shadow-inner"
      />
    </div>
  );
}
