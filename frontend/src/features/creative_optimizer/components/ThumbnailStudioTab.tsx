...
import ThumbnailGenerator from "@/features/media_thumbnails/components/ThumbnailGenerator";
import ThumbnailLayoutForm from "@/features/media_thumbnails/components/ThumbnailLayoutForm";
import ThumbnailCompositionGuide from "@/features/media_thumbnails/components/ThumbnailCompositionGuide";
    ...
    <div className="space-y-4 w-full animate-fade-in">
      ...
      <div className="bg-neutral-900/60 p-4 rounded-2xl border border-neutral-850 hover:border-[#3B82F6]/40 transition-all space-y-2 shadow-xl">
        ...
        <p className="text-[10px] text-neutral-400 font-mono">
          Extract key focal assets, draft high-CTR text overlays, and generate
          16:9 clickbait composition recipes.
        </p>
      </div>

      {/* SUB-TAB SELECTOR */}
      <div className="flex border-b border-neutral-850 gap-2 font-mono overflow-x-auto pb-1">
        {subTools.map((tool) => {
      ...
      <div className="space-y-4 pt-1">
        ...
        {activeSubTab === "concept" && (
          <div className="bg-neutral-900/60 border border-neutral-850 rounded-2xl p-5 space-y-4 shadow-xl">
            <div className="flex justify-between items-center border-b border-neutral-850 pb-3">
              <span className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
                <Lightbulb className="w-4 h-4 text-amber-400" /> Clickbait
                Concept Drafts
              </span>
            ...
            <textarea
              ...
              rows={4}
              className="w-full text-xs font-sans text-white bg-neutral-950 p-3 rounded-xl border border-neutral-800 outline-none focus:border-pink-500/50 resize-y"
            />
            <div className="p-3 bg-neutral-950 border border-neutral-800 rounded-xl text-[11px] text-neutral-300 space-y-1">
              <p className="font-bold text-pink-300">
                Recommended Thumbnail Overlay Formula:
              </p>
              <p className="text-neutral-400">
                1. Maximum 3 to 4 high-contrast words (yellow or white text with
                thick black stroke).
              </p>
              <p className="text-neutral-400">
                2. Exaggerated expression (shock, fury, or sinister smirk).
              </p>
              <p className="text-neutral-400">
                3. Dark background with vibrant neon focal glow (purple or cyan
                aura).
              </p>
            </div>
          </div>
