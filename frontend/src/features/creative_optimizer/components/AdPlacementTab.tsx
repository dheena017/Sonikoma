    ...
    <div className="space-y-4 w-full animate-fade-in">
      ...
      {loading && (
        <div className="bg-neutral-900/60 border border-neutral-850 rounded-2xl p-10 text-center animate-pulse space-y-3 shadow-xl">
          <Megaphone className="h-8 w-8 text-[#3B82F6] animate-spin mx-auto" />
            ...
            {placements.map((p, idx) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="bg-neutral-900 text-[#60A5FA] font-mono text-xs px-3 py-1 rounded-lg border border-neutral-800 font-bold flex items-center gap-1.5 shrink-0">
