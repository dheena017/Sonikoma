...
export default function StoryboardEmptyState({
  ...
  return (
    <div
      ...
      className="relative w-full flex-1 min-h-[220px] sm:min-h-[260px] flex flex-col items-center justify-center p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/5 text-center space-y-3 select-none overflow-hidden"
    >
