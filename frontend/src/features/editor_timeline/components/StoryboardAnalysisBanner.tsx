    ...
    <div className="bg-gradient-to-r from-blue-950/60 via-indigo-950/50 to-neutral-950 border border-blue-500/30 rounded-xl px-4 py-3 flex items-center justify-between gap-3 animate-in fade-in duration-200 shadow-lg shadow-blue-950/40 my-2">
      ...
      {handleCancelAnalysis && (
        <button
          ...
          className="text-[10px] font-bold text-neutral-400 hover:text-white bg-neutral-900/80 hover:bg-neutral-800 border border-neutral-800 px-3 py-1.5 rounded-lg transition-colors duration-75 active:scale-95 active:duration-75 [touch-action:manipulation] cursor-pointer shrink-0"
        >
          Cancel
        </button>
      )}
