      ...
      <div className="flex items-start gap-3 mb-2">
        {imgSrc && !imageError ? (
          <img
            ...
            onError={() => {
              if ((imgSrc.includes("/api/v1/proxy/image") || imgSrc.includes("/api/proxy-image")) && series.cover_image) {
