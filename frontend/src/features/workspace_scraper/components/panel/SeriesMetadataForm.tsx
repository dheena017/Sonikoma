      ...
      <div className="space-y-3">
        <div className="space-y-1 relative" ref={titleContainerRef}>
          ...
          <input
            ...
            className="w-full bg-neutral-950 border border-neutral-800 focus:border-neutral-600 rounded-xl px-4 py-2.5 text-sm text-neutral-200 outline-none transition-all"
          />
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder="72"
              className="w-full bg-neutral-950 border border-neutral-800 focus:border-neutral-600 rounded-xl px-4 py-2.5 text-sm text-neutral-200 outline-none transition-all font-mono"
            />
          </div>
