...
import { EpisodeGrid } from "@/features/workspace_scraper/components/EpisodeGrid";
import { EpisodeControls } from "@/features/workspace_scraper/components/EpisodeControls";
import { FavoritesManager, FavoritesList, FavoriteSeries, FAVORITES_UPDATED_EVENT } from "@/features/workspace_scraper/components/FavoritesManager";
import { BatchThumbnailDownloader } from "@/features/workspace_scraper/components/BatchThumbnailDownloader";
import { EpisodePreviewModal } from "@/features/workspace_scraper/components/EpisodePreviewModal";
import { AnalyticsDashboard } from "@/features/workspace_scraper/components/AnalyticsDashboard";
          ...
          <div className="relative space-y-2 md:col-span-2" ref={suggestionsContainerRef}>
            ...
            <div className="relative group">
              ...
              {showSuggestions && suggestions.length > 0 && (
                <div className="absolute left-0 right-0 top-full mt-2 bg-[#111116] border border-neutral-800 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] z-[200] overflow-hidden">
