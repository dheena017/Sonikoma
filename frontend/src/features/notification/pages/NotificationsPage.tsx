...
import { Notification } from "@/features/notification/components/types";
import { formatDistanceToNow } from "date-fns";
import { useNotificationExpand, useNotificationFiltering } from "@/features/notification/hooks";
import { getNotificationIconBox, getTypeStyles } from "@/features/notification/utils";
...
const NotificationsPage = React.memo(
  ({
    ...
    return (
      <div className="flex-grow flex-1 bg-[#0a0a0e] text-white py-6 md:py-10 px-4 sm:px-6 lg:px-8 relative">
