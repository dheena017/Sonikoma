...
export default function DashboardStats({
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-8">
      <div className="bg-neutral-900/40 border border-white/5 rounded-3xl p-6 shadow-md relative overflow-hidden group">
      ...
      <div className="bg-neutral-900/40 border border-white/5 rounded-3xl p-6 shadow-md relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
      ...
      <div className="bg-neutral-900/40 border border-white/5 rounded-3xl p-6 shadow-md relative overflow-hidden group hover:border-amber-500/30 transition-colors">
      ...
      <div className="bg-neutral-900/40 border border-white/5 rounded-3xl p-6 shadow-md relative overflow-hidden group hover:border-indigo-500/30 transition-colors">
