          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <h3 className="text-xs font-black text-purple-400 uppercase tracking-widest font-mono flex items-center gap-1.5">
                <Key className="w-4 h-4" /> API Keys &amp; Providers
              </h3>
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight font-sans">
              API Keys &amp; Provider Vault
            </h1>
            <p className="text-xs sm:text-sm text-neutral-400 max-w-2xl font-mono leading-relaxed">
              Connect your own API keys (BYOK) for Google Gemini, OpenAI, Claude, Groq, and more. Keys and Project configurations remain securely stored in your local browser storage.
            </p>
          </div>
