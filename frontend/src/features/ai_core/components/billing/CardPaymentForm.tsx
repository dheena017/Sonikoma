      ...
      <div className="space-y-3 text-xs text-left">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full bg-black/40 border border-white/10 rounded-xl py-2 px-3 focus:border-[#3B82F6]/60 text-white focus:outline-none placeholder:text-neutral-600 font-sans"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full bg-black/40 border border-white/10 rounded-xl py-2.5 px-3 focus:border-[#3B82F6]/60 text-white focus:outline-none font-mono placeholder:text-neutral-600"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="MM/YY"
              className="w-full bg-black/40 border border-white/10 rounded-xl py-2 px-3 focus:border-[#3B82F6]/60 text-white focus:outline-none font-mono placeholder:text-neutral-600"
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">
