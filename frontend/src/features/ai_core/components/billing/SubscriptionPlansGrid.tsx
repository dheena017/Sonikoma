      ...
      <div className="bg-gradient-to-b from-[#121218]/90 to-[#070709]/90 border border-[#3B82F6]/30 rounded-3xl p-6 text-left space-y-4 shadow-xl relative overflow-hidden flex flex-col justify-between">
        ...
        {subscriptionTier !== "pro" && onSelectPlan && (
          <button
            ...
            className="w-full py-2 bg-[#2A2A2A] hover:bg-[#333333] text-white font-bold rounded-xl text-xs transition-all shadow-md shadow-sm active:scale-95 cursor-pointer mt-2"
          >
      ...
      <div className="bg-[#0f0f13]/50 border border-white/5 rounded-3xl p-6 text-left space-y-4 flex flex-col justify-between">
        ...
        <form onSubmit={onApplyCoupon} className="space-y-2">
          <input
            ...
            className="w-full bg-black/40 border border-white/10 focus:border-neutral-600 rounded-xl py-2 px-3 text-xs font-semibold text-white focus:outline-none focus:ring-2 focus:ring-neutral-700 transition-all placeholder:text-neutral-600 uppercase font-mono"
          />
          <button
            type="submit"
            className="w-full bg-[#2A2A2A] hover:bg-[#333333] text-white font-bold py-2 rounded-xl text-xs transition-all cursor-pointer shadow-sm active:scale-95"
          >
            Apply Coupon
          </button>
        </form>
