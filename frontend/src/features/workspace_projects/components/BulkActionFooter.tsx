...
export default function BulkActionFooter({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 md:left-64 p-4 z-50 animate-in slide-in-from-bottom-10 duration-300">
      <div className="max-w-4xl mx-auto bg-gradient-to-r from-[#2A2A2A] to-[#0b0b0e]/95 backdrop-blur-xl border border-[#3B82F6]/50 rounded-2xl p-4 flex items-center justify-between shadow-2xl shadow-black/50">
        <div className="flex items-center gap-4">
          <div className="bg-[#2A2A2A] text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">
            {selectedCount}
          </div>
