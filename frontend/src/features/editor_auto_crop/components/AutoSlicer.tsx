      ...
      <div className="flex gap-2 p-1.5 bg-neutral-950/90 rounded-2xl border border-neutral-800">
        <button
          ...
          className={`flex-1 py-2 rounded-xl text-xs font-mono font-bold transition-all cursor-pointer ${
            strategy === "local-cv"
              ? "bg-gradient-to-r from-[#2A2A2A] via-[#2A2A2A] to-[#2A2A2A] text-white  border border-[#3B82F6]/40"
      ...
      <div className="flex items-center gap-2 w-full">
        {isDetecting ? (
          ...
          <button
            type="button"
            onClick={handleScan}
            className="flex-1 py-3 px-4 bg-gradient-to-r from-blue-600 via-indigo-600 to-[#2A2A2A] hover:from-blue-500 hover:to-indigo-500 text-white rounded-2xl flex items-center justify-center gap-2 transition-all text-xs font-black uppercase tracking-widest cursor-pointer active:scale-95 shadow-[0_4px_14px_rgba(139,92,246,0.3)] hover:shadow-[0_6px_20px_rgba(139,92,246,0.5)] border border-[#60A5FA]/30"
          >
