...
import {
  useLandingPage,
  useNewsletterForm,
} from "@/features/app_landing/hooks";
import {
  FeatureCard,
  Step,
  PricingCard,
...
const PLATFORMS = [
  {
    name: "WEBTOON",
    badge: "Direct Import",
    desc: "Official English & Global Webtoons",
  },
  {
    name: "MangaDex",
    badge: "Full Support",
    desc: "Multi-language Community Scans",
  },
  {
    name: "Naver Webtoon",
    badge: "Auto Translation",
    desc: "Raw Korean Chapters & Webtoons",
  },
  {
    name: "KakaoPage",
    badge: "High Res",
    desc: "High-resolution Vertical Comics",
  },
...
const TESTIMONIALS = [
  {
    quote:
      "Sonikoma cut my webtoon recap video editing time from 8 hours down to 15 minutes. The panel slicing and auto-camera pans look like a professional anime studio made it!",
    author: "Alex Chen",
  ...
  {
    quote:
      "Removing speech bubbles manually in Photoshop used to drive me crazy. Sonikoma erases bubbles seamlessly in one click while keeping character artwork intact.",
  ...
  {
    quote:
      "The auto-translation feature allows me to summarize Naver Webtoons for my English audience days before official releases. Essential tool for any webtoon channel.",
    author: "Daisuke Sato",
    handle: "@AnimeNexus",
    rating: 5,
    role: "Comic Reviewer",
      ...
      >
        ...
        <section className="relative pt-20 pb-20 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center space-y-8 relative z-10">
            ...
            >
              ...
              and render high-converting TikTok, Shorts, and Reels in seconds.
            </p>
        ...
        <section id="platforms" className="py-24 px-6 scroll-mt-24">
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="text-center space-y-3">
              ...
              >
                Import chapters directly from top platforms or upload custom
                image zip files.
              </p>
            </div>
        ...
        >
          <div className="max-w-7xl mx-auto space-y-20">
            <div className="text-center space-y-4">
              ...
              >
                We handle the complex image processing, text erasure, TTS
                dubbing, and video editing so you can focus on storytelling.
              </p>
            </div>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="text-center space-y-4">
              ...
              >
                Switch between tabs below to inspect how raw webtoon chapters
                become animated, voiced video clips.
              </p>
            </div>
        ...
        <section id="pricing" className="py-32 px-6 scroll-mt-24">
          <div className="max-w-7xl mx-auto space-y-16">
            <div className="text-center space-y-4">
              ...
              >
                Start free, upgrade as your subscriber base grows. No hidden
                fees.
              </p>
        ...
        >
          <div className="max-w-7xl mx-auto space-y-16">
            <div className="text-center space-y-4">
              ...
              >
                Here is what top YouTube Shorts, TikTok, and webtoon creators
                say about Sonikoma.
              </p>
            </div>
        ...
        <section id="faq" className="py-32 px-6 scroll-mt-24">
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center space-y-4">
              ...
              >
                Everything you need to know about Sonikoma comic video
                generation.
              </p>
            </div>
        ...
        >
          ...
          >
            ...
            >
              Subscribe to our weekly creator newsletter for early feature
              updates, viral TikTok growth tips, and voice cloning guides.
            </p>
            <form
        ...
        <section className="py-24 px-6">
          <div className="max-w-5xl mx-auto bg-gradient-to-br from-purple-600 via-indigo-600 to-purple-800 rounded-[40px] p-12 md:p-20 text-center space-y-8 shadow-2xl shadow-purple-900/50 relative overflow-hidden">
            ...
            <p className="max-w-xl mx-auto text-purple-100 text-base md:text-lg font-medium relative z-10">
              Transform any webtoon chapter into voiced vertical videos in
              seconds.
            </p>
