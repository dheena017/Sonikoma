...
export function TranslationAfter() {
  return (
    <div className="w-full h-full flex items-center justify-center p-6 bg-[#0d0e15] relative overflow-hidden">
      <div className="w-72 h-72 rounded-2xl bg-gradient-to-br from-rose-950 via-slate-900 to-purple-950 border-2 border-purple-400 p-4 flex flex-col justify-between relative overflow-hidden shadow-2xl shadow-purple-500/10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(168,85,247,0.35),transparent_60%)]" />

        <div className="relative z-10 flex items-center justify-between">
          <span className="text-[10px] font-mono font-bold text-purple-400 bg-black/50 px-2 py-0.5 rounded border border-purple-500/30 flex items-center gap-1">
