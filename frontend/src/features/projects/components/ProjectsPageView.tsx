...
import ProjectsPageResultView from "@/features/projects/components/ProjectsPageResultView";
import type { Project, ViewMode } from "@/features/projects/hooks/ProjectTypes";
...
export default function ProjectsPageView({
  ...
  return (
    <div className="w-full min-h-full bg-neutral-955 text-neutral-100 flex flex-col pt-6 px-6 sm:px-12 md:px-20 lg:px-32 animate-fade-in relative z-10 pb-32">
