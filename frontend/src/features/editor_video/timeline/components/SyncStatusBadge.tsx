...
const SyncStatusBadge: React.FC<SyncStatusBadgeProps> = ({
  ...
  switch (status) {
    case "synced":
      return (
        <span
          className="flex items-center gap-1 text-emerald-400 text-[9px] font-mono"
          title="Synced with repo & cache"
        >
    ...
    case "syncing":
      return (
        <span
          className="flex items-center gap-1 text-amber-300 text-[9px] font-mono"
          title="Syncing asset to cache..."
        >
    ...
    case "dirty":
      return (
        <span
          className="flex items-center gap-1 text-amber-400 text-[9px] font-mono"
          title="Unsaved changes (local draft)"
        >
    ...
    case "error":
      return (
        <span
          className="flex items-center gap-1 text-red-400 text-[9px] font-mono"
          title="Sync error"
        >
