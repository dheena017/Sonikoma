    ...
    <div className="p-3 rounded-xl bg-neutral-900 border border-neutral-800 hover:border-[#3B82F6]/60 transition-all flex items-center justify-between group shadow-sm">
      ...
      {resource.hex ? (
        <button
          ...
          className="px-2 py-1 rounded-lg bg-neutral-800 hover:bg-[#3B82F6] text-white text-[9px] font-mono font-bold flex items-center gap-1 shrink-0 transition-colors cursor-pointer"
        >
