  ...
  return (
    <div className="px-3.5 py-2 border-b border-purple-900/15 bg-black/40 flex items-center gap-1.5 overflow-x-auto mini-sidebar-scrollbar">
      ...
      <button
        ...
        className="px-2.5 py-1 rounded-lg bg-[#3B82F6]/10 hover:bg-[#3B82F6]/20 border border-[#3B82F6]/20 text-purple-200 text-[10px] font-mono flex items-center gap-1 shrink-0 transition-all cursor-pointer"
      >
        <Scissors className="h-3 w-3 text-[#3B82F6]" />
        <span>Remove BG</span>
      </button>
