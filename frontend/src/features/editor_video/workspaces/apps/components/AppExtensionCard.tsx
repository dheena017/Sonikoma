...
export const AppExtensionCard: React.FC<AppExtensionCardProps> = ({ app, isInstalled, onToggle }) => {
  return (
    <div className={`rounded-xl bg-gradient-to-br ${app.color} border overflow-hidden transition-all`}>
