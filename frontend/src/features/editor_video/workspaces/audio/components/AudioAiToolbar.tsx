    ...
    <div className="px-3 py-2 bg-purple-950/20 border-b border-purple-900/30 flex items-center justify-between gap-1 overflow-x-auto [scrollbar-width:none]">
      ...
      <div className="flex items-center gap-1 shrink-0">
        <button
          ...
          className="px-2 py-1 rounded bg-purple-900/40 hover:bg-[#3B82F6] text-purple-200 hover:text-white text-[9px] font-mono font-bold flex items-center gap-1 border border-[#3B82F6]/30 transition-all cursor-pointer whitespace-nowrap"
        >
