...
export const AudioWorkspaceHeader: React.FC<AudioWorkspaceHeaderProps> = ({
  ...
  <div className="shrink-0">
    <div className="px-3.5 py-2.5 border-b border-neutral-900/30 bg-neutral-950/80 backdrop-blur-md flex items-center justify-between">
      <div className="flex items-center gap-2.5">
        <div className="h-6 w-6 rounded-lg bg-blue-500/20 border border-blue-500/40 flex items-center justify-center shadow-[0_0_10px_rgba(139,92,246,0.3)]">
          <Music className="h-3.5 w-3.5 text-[#60A5FA]" />
        </div>
