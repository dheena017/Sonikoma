...
export const StorySceneCard: React.FC<StorySceneCardProps> = ({
  ...
  return (
    <div
      ...
      className="p-3 rounded-[1.75rem] bg-[#1E1E1E] border border-[#2F2F2F] hover:border-neutral-700 cursor-pointer transition-all space-y-2 group shadow-[0_18px_42px_rgba(0,0,0,0.18)] hover:shadow-[0_18px_48px_rgba(59,130,246,0.22)]"
    >
      <div className="flex items-center justify-between border-b border-neutral-800/80 pb-1.5">
        <div className="flex items-center gap-1.5 min-w-0">
          <span className="text-[10px] font-mono font-semibold text-white bg-[#3B82F6] px-2 py-0.5 rounded-full border border-[#60A5FA]/40 shadow-xs shadow-blue-500/25 shrink-0">
