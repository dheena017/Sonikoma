  ...
  <div className="shrink-0">
    <div className="px-3.5 py-2.5 border-b border-purple-900/30 bg-neutral-950/80 backdrop-blur-md flex items-center justify-between">
      <div className="flex items-center gap-2.5">
        ...
        <h2 className="text-xs font-black text-white uppercase tracking-wider font-mono">Text & Captions</h2>
      </div>
    ...
    <WorkspaceLayoutSearch value={searchQuery} onChange={onSearchChange} placeholder="Search text presets..." />
  </div>
);
