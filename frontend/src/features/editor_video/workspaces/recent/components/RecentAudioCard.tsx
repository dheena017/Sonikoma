...
export const RecentAudioCard: React.FC<{
  ...
  <div
    onClick={onAction}
    className="p-3 rounded-[1.75rem] bg-[#07060f] border border-white/5 shadow-[0_18px_42px_rgba(0,0,0,0.18)] hover:border-violet-500/25 hover:shadow-[0_18px_48px_rgba(59,130,246,0.22)] transition-all duration-200 flex items-center justify-between gap-3 group cursor-pointer"
  >
      ...
      <div className="min-w-0 flex-1 space-y-1">
        ...
        <div className="flex flex-wrap items-center gap-2 text-[10px] text-neutral-400 font-mono">
          ...
          <span className="flex items-center gap-1 shrink-0">
            <Clock className="h-3 w-3 text-violet-400" /> {item.timeAgo}
          </span>
