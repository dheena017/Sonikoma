...
export const RecentFontCard: React.FC<{ item: RecentItem; onAction: () => void }> = ({ item, onAction }) => (
  ...
  >
    <div className="flex items-center gap-3 min-w-0 flex-1">
      <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-purple-900/60 to-purple-950/90 border border-purple-500/40 flex items-center justify-center shrink-0 shadow-inner group-hover:scale-105 transition-transform">
        <Type className="h-4.5 w-4.5 text-purple-300" />
      </div>
