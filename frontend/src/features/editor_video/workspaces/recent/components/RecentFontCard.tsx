...
export const RecentFontCard: React.FC<{
  item: RecentItem;
  onAction: () => void;
}> = ({ item, onAction }) => (
  <div
  ...
  >
    <div className="flex items-center gap-3 min-w-0 flex-1">
      <div className="h-11 w-11 rounded-3xl bg-purple-500/12 border border-purple-500/20 flex items-center justify-center shrink-0 shadow-inner group-hover:scale-105 transition-transform">
        <Type className="h-5.5 w-5.5 text-purple-300" />
      </div>
