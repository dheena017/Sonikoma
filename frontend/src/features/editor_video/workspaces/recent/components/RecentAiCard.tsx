  ...
  >
    <div className="flex items-center gap-3 min-w-0 flex-1">
      <div className="h-11 w-11 rounded-3xl bg-blue-500/12 border border-blue-500/20 flex items-center justify-center shrink-0 shadow-inner group-hover:scale-105 transition-transform">
        <Wand2 className="h-5.5 w-5.5 text-[#60A5FA]" />
      </div>
      <div className="min-w-0 flex-1 space-y-1">
        <h4 className="text-xs font-semibold text-white group-hover:text-white leading-tight font-sans truncate">
          {item.title}
        </h4>
        <div className="flex flex-wrap items-center gap-2 text-[10px] text-neutral-400 font-mono">
          <span className="text-[9px] uppercase tracking-[0.18em] bg-blue-500/15 text-neutral-200 px-2 py-0.5 rounded-full border border-blue-500/20 font-semibold shrink-0">
            Used {item.usesCount}x
          </span>
          <span className="flex items-center gap-1 shrink-0">
            <Clock className="h-3 w-3 text-[#60A5FA]" /> {item.timeAgo}
          </span>
    ...
    <button
      ...
      className="px-3 py-1.5 rounded-2xl bg-gradient-to-r from-blue-500 via-blue-600 to-blue-600 text-white text-[10px] font-mono font-bold uppercase tracking-[0.04em] flex items-center gap-1.5 shrink-0 transition-all  active:scale-95"
    >
