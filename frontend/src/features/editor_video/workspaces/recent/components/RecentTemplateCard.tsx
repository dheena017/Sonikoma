...
export const RecentTemplateCard: React.FC<{
  ...
  <div
    onClick={onAction}
    className="p-3 rounded-[1.75rem] bg-[#07060f] border border-white/5 shadow-[0_18px_42px_rgba(0,0,0,0.18)] hover:border-amber-500/25 hover:shadow-[0_18px_48px_rgba(168,85,247,0.22)] transition-all duration-200 flex items-center justify-between gap-3 group cursor-pointer"
  >
