...
export const StoryboardPromptsView: React.FC<StoryboardPromptsViewProps> = ({
  ...
  return (
    <div className="space-y-3 pt-1 pb-4">
      {/* Banner */}
      <div className="p-2.5 rounded-xl bg-pink-950/30 border border-pink-500/20 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 text-[10px] font-mono text-pink-200">
        ...
        <button
          ...
          className="px-2 py-0.5 rounded-md bg-pink-600 hover:bg-pink-500 text-white text-[9px] font-mono font-bold flex items-center gap-1 shrink-0 cursor-pointer shadow-sm transition"
        >
        ...
        return (
          <div
            ...
            className={`p-3 rounded-2xl border transition-all flex flex-col gap-2.5 cursor-pointer ${
              isSelected
                ? "border-pink-500 bg-pink-950/25 ring-2 ring-pink-500/50 shadow-md"
                : "border-white/10 bg-[#0c0d1b] hover:border-pink-500/40"
            }`}
          >
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2 min-w-0">
                <div className="relative w-10 h-10 rounded-lg overflow-hidden bg-black/60 shrink-0 border border-white/10">
                  ...
                  <span className="absolute bottom-0 right-0 text-[7px] font-black font-mono bg-black/80 text-pink-200 px-0.5 rounded">
                    #{index + 1}
                  </span>
                </div>

                <div className="min-w-0">
                  <span className="text-[10px] font-bold font-mono text-pink-300">
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <button
                  ...
                  className="p-1 px-1.5 rounded-lg bg-pink-600/20 hover:bg-pink-600/40 border border-pink-500/30 text-pink-200 text-[8px] font-mono flex items-center gap-1 transition-all"
            ...
            <textarea
              ...
              className="w-full h-18 p-2 rounded-xl bg-black/50 border border-white/10 text-white placeholder-neutral-500 text-[10px] font-mono resize-none focus:outline-none focus:border-pink-500/60 transition-colors leading-relaxed"
            />
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto mini-sidebar-scrollbar">
              ...
              {STYLE_TAGS.map((tag) => (
                <button
                  ...
                  className="px-2 py-0.5 rounded-lg bg-black/40 hover:bg-pink-950/40 border border-white/5 hover:border-pink-500/30 text-[8px] font-mono text-neutral-400 hover:text-pink-200 whitespace-nowrap transition-all"
                >
                  +{tag}
                </button>
              ))}
