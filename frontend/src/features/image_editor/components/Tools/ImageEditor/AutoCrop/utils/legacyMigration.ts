import { AutoCropSettings } from '@/features/image_editor/components/Tools/ImageEditor/AutoCrop/types';
import { defaultAutoCropSettings } from '@/features/image_editor/components/Tools/ImageEditor/AutoCrop/contexts/AutoCropContext';
