                          ...
                          <>
                            ...
                            <div className="pt-2 border-t border-neutral-850">
                              <button
                                ...
                                className="w-full px-3.5 py-2.5 rounded-2xl bg-neutral-900/80 hover:bg-[#3B82F6]/10 text-xs font-sans font-bold text-neutral-200 border border-neutral-800 hover:border-[#3B82F6]/30 text-center transition-all glass-interactive active:scale-95 cursor-pointer truncate shadow-sm"
                              >
                                ✅ Select All Panels
                              </button>
                            </div>
