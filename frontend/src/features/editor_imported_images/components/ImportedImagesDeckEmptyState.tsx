...
/**
 * State-of-the-art Empty State for ChapterScraperDeck displayed when no Webtoon images are imported.
...
export default function ChapterScraperDeckEmptyState({
  ...
  description = "Paste a Webtoon episode URL in the input above to extract high-resolution panels into the chapter scraper deck.",
  icon,
