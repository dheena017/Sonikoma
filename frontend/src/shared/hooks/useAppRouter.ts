...
const ROUTE_PREFETCH_MAP: Record<string, () => Promise<any>> = {
  ...
  "/auth/callback": () => import("@/features/app_auth/pages/AuthCallbackPage"),
  "/auth/redirect": () => import("@/features/app_auth/pages/AuthCallbackPage"),
  "/auth/google/callback": () => import("@/features/app_auth/pages/AuthCallbackPage"),
  "/auth/launch": () => import("@/features/app_auth/pages/AuthCallbackPage"),
