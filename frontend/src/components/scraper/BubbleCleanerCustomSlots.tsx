...
export function BubbleCleanerCustomSlots({ customPresets, savePreset, loadPreset, exportPresets, importPresets }: Props) {
    ...
    <div className="space-y-3 pt-2">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button onClick={exportPresets} className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg border border-neutral-800 bg-neutral-900/60 hover:bg-neutral-800 text-neutral-400 hover:text-white transition-all text-[8px] font-bold font-mono active:scale-95 cursor-pointer">
