  ...
  const sections = [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "jwt_expiry_hours", label: "JWT Expiry (Hours)", type: "number" },
      ],
    },
    {
      id: "notifications",
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "concurrent_scrapes_per_user", label: "Concurrent Scrapes Limit", type: "number" },
      ],
    },
  ];
    ...
    <div className="space-y-6 animate-[fadeIn_0.2s_ease-out]">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-neutral-500">Configure global application behavior and integrations</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {sections.map((section) => (
          <div key={section.id} className="bg-[#111115] border border-neutral-800 rounded-xl overflow-hidden">
      ...
      <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-neutral-400 mt-1">Actions here are permanent and affect the entire platform.</p>
