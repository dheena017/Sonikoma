...
export const PRESETS = [
  {
    ...
    detectionStyle: "all" as const,
    eraseMethod: "auto" as const,
    sensitivity: 50,
    dilation: -1,
    inpaintRadius: 3,
  },
  {
    ...
    detectionStyle: "white_only" as const,
    eraseMethod: "inpaint" as const,
    sensitivity: 65,
    dilation: 8,
    inpaintRadius: 4,
  },
  {
    ...
    detectionStyle: "text_only" as const,
    eraseMethod: "blur" as const,
    sensitivity: 45,
    dilation: 2,
    inpaintRadius: 1,
  },
  {
    ...
    icon: "⬜",
    description: "Fill speech bubbles with solid white color",
    detectionStyle: "white_only" as const,
    eraseMethod: "solid_white" as const,
    sensitivity: 50,
    dilation: 4,
    inpaintRadius: 1,
  },
