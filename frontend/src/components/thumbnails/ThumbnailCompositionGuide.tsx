...
export default function ThumbnailCompositionGuide({ conceptPrompt }: ThumbnailCompositionGuideProps) {
    ...
    <div className="bg-neutral-900/40 border border-neutral-800 rounded-2xl p-5 space-y-4 md:col-span-2">
      <div className="flex justify-between items-center border-b border-neutral-800 pb-3">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-xs font-mono font-bold text-white uppercase">AI Canvas Splits & Borders Guide</h4>
        </div>
        <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-[10px] font-mono animate-fade-in">
          <div className="bg-neutral-955 p-3 rounded-lg border border-neutral-850 space-y-2">
            <div className="flex justify-between border-b border-neutral-900 pb-1.5">
              ...
              <span className="text-purple-300 font-bold">{data.split_screen_ratio}</span>
            </div>
            <div>
              <span className="text-neutral-500 block">Layout margins guideline:</span>
              <p className="text-neutral-300 font-sans mt-0.5 leading-relaxed">{data.layout_margins}</p>
            </div>
          </div>

          <div className="bg-neutral-955 p-3 rounded-lg border border-neutral-850 space-y-2">
            <div>
              <span className="text-neutral-500 block uppercase">Canvas Background detail:</span>
              <p className="text-neutral-300 font-sans mt-0.5 leading-relaxed">{data.background_style}</p>
            </div>
            <div className="pt-1">
              <span className="text-neutral-500 block">Target Highlight borders:</span>
